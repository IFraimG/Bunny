...
В ходе начальных спринтов была проведена работа над выполнением основных задач, полностью завершены и закрыты:
* Сохранение информации о пароле с зашифрованном виде
* Получение информации о паролях
* Просмотр пароля в расшифрованном виде
* Изменение информации о пароле
...
* Настройка DataStore для хранения ключа доступа к приложению и файлам
* Отображение файлов

### Sprint Retrospectives
* Была попытка настроить шифрование через EncryptSharedPreferences, но оно оказалось deprecated, поэтому был проведен поиск альтерантивного решения
